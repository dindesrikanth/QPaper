...
public class StatusGridViewAdapter extends RecyclerView.Adapter<StatusGridViewAdapter.CategoryViewHolder> {

    private List<Questionesmodel> answersList;
    Context context;
    private StatusGridViewAdapter.OnItemClickListenerbtn mListeners;
    int currentQuestionPosition;

    public interface OnItemClickListenerbtn {
        void quesclick(int position);
    }
    public void setOnItemClickListener(StatusGridViewAdapter.OnItemClickListenerbtn listener) {
        mListeners = listener;
    }

    public StatusGridViewAdapter(List<Questionesmodel> answersList, Context context, int currentQuestionPosition) {
    ...
    public CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View categoryProductView = LayoutInflater.from(parent.getContext()).inflate(R.layout.grid_item, parent, false);
